  ...
  <div>
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      >
        ...
        >
          <!-- Inner overlay: same size as outer because it's the only block child.
               Bg darkens for readability; lightens on hover; backdrop-blur keeps the
               image readable behind a soft frost (not `blur-*` which would blur text). -->
          <div
